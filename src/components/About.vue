...
<div class="max-w-[85rem] -mt-48 sm:-mt-64  md:-mt-96 lg:mt-auto  lg:mb-auto px-4 py-10 lg:px-20 lg:py-14 mx-auto">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-8">
    ...
    <div class="lg:order-1  mx-auto md:max-w-[600px]  lg:max-w-[484px]">
      <p class="mb-5 inline-flex items-center gap-1.5 py-1.5 px-3 rounded-lg text-xl font-semibold  text-[#D71F29] dark:bg-neutral-800 dark:text-neutral-200">
        من نحن
      </p>

      <h2 class="text-2xl font-bold lg:text-3xl lg:leading-tight  xl:leading-tight text-gray-800 dark:text-neutral-200">
